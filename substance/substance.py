...
materials.append(Material('08Х18Н12М3Т',
                          {
                              ...
                              'sigma_100000': interpolate.interp1d(array((650, 700, 760, 815)) + T0,
                                                                   ...
                                                                   kind=3, fill_value=nan, bounds_error=False), },
                          reference=REFERENCES[2] + ', c. 402', ))
materials.append(Material('40Х15Н7ГФ2МС',
                          {
                              'sigma_s': interpolate.interp1d(array((20, 300, 400, 500, 600, 700, 800, 900, 1000)) + T0,
                                                              array((1000, 810, 780, 700, 640, 520, 380, 250, 160)) * M,
                                                              kind=3, fill_value=nan, bounds_error=False),
                              'sigma_t': interpolate.interp1d(array((20, 300, 400, 500, 600, 700, 800)) + T0,
                                                              array((600, 550, 540, 490, 500, 430, 280)) * M,
                                                              kind=3, fill_value=nan, bounds_error=False),
                              'sigma_100': interpolate.interp1d(array((600, 700, 800, 900)) + T0,
                                                                array((430, 250, 130, 75)) * M,
                                                                kind=3, fill_value=nan, bounds_error=False),
                              'sigma_1000': interpolate.interp1d(array((600, 700, 800)) + T0,
                                                                 array((320, 180, 84)) * M,
                                                                 kind=2, fill_value=nan, bounds_error=False),
                              'sigma_10000': interpolate.interp1d(array((600, 700, 800)) + T0,
                                                                  array((250, 110, 50)) * M,
                                                                  kind=2, fill_value=nan, bounds_error=False), },
                          reference=REFERENCES[2] + ', c. 406-407', ))
materials.append(Material('37Х12Н8Г8МФБ',
                          {
                              'sigma_s': interpolate.interp1d(array((20, 200, 300, 350, 400, 450, 500, 550, 600, 650,
                                                                     700, 750)) + T0,
                                                              array((1000, 770, 740, 730, 730, 720, 680, 660, 600, 560,
                                                                     500, 420)) * M,
                                                              kind=3, fill_value=nan, bounds_error=False),
                              'sigma_t': interpolate.interp1d(array((20, 200, 300, 350, 400, 450, 500, 550, 600, 650,
                                                                     700, 750)) + T0,
                                                              array((600, 600, 540, 520, 500, 500, 500, 490, 490, 450,
                                                                     430, 380)) * M,
                                                              kind=3, fill_value=nan, bounds_error=False),
                              'sigma_100': interpolate.interp1d(array((600, 650, 700)) + T0,
                                                                array((450, 370, 310)) * M,
                                                                kind=2, fill_value=nan, bounds_error=False),
                              'sigma_1000': interpolate.interp1d(array((600, 650, 700)) + T0,
                                                                 array((340, 250, 230)) * M,
                                                                 kind=2, fill_value=nan, bounds_error=False),
                              'sigma_5000': interpolate.interp1d(array((600, 650, 700)) + T0,
                                                                 array((310, 220, 190)) * M,
                                                                 kind=2, fill_value=nan, bounds_error=False),
                              'sigma_10000': interpolate.interp1d(array((600, 650, 700)) + T0,
                                                                  array((300, 210, 180)) * M,
                                                                  kind=2, fill_value=nan, bounds_error=False), },
                          reference=REFERENCES[2] + ', c. 407', ))
materials.append(Material('08Х16Н13М2Б',
                          {
                              'sigma_s': interpolate.interp1d(array((20, 500, 600, 650)) + T0,
                                                              array((620, 490, 470, 440)) * M,
                                                              kind=3, fill_value=nan, bounds_error=False),
                              'sigma_t': interpolate.interp1d(array((20, 500, 600, 650)) + T0,
                                                              array((230, 175, 175, 175)) * M,
                                                              kind=3, fill_value=nan, bounds_error=False),
                              'sigma_10000': interpolate.interp1d(array((550, 600, 650, 700)) + T0,
                                                                  array((260, 200, 130, 60)) * M,
                                                                  kind=3, fill_value=nan, bounds_error=False),
                              'sigma_100000': interpolate.interp1d(array((550, 600, 650, 700)) + T0,
                                                                   array((210, 150, 95, 35)) * M,
                                                                   kind=3, fill_value=nan, bounds_error=False),
                              'alpha': interpolate.interp1d(array((400, 600, 800)) + T0,
                                                            array((17.1, 17.8, 18.6)) / M,
                                                            kind=2, fill_value=nan, bounds_error=False),
                              'E': interpolate.interp1d(array((20, 200, 400, 600, 650)) + T0,
                                                        array((206, 191, 174, 167, 158)) * 10 ** 9,
                                                        kind=3, fill_value=nan, bounds_error=False),
                              'l': interpolate.interp1d(array((200, 400, 600, 650, 700)) + T0,
                                                        array((17.1, 20.1, 21.7, 23.0, 24.7)),
                                                        kind=3, fill_value=nan, bounds_error=False), },
                          reference=REFERENCES[2] + ', c. 408', ))
materials.append(Material('09Х14Н16Б',
                          {
                              'sigma_s': interpolate.interp1d(array((20, 600, 650, 700)) + T0,
                                                              array((570, 400, 360, 330)) * M,
                                                              kind=3, fill_value=nan, bounds_error=False),
                              'sigma_t': interpolate.interp1d(array((20, 600, 650, 700)) + T0,
                                                              array((250, 188, 160, 160)) * M,
                                                              kind=3, fill_value=nan, bounds_error=False),
                              'KCU': interpolate.interp1d(array((20, 600, 700)) + T0,
                                                          array((2.1, 3.3, 3.3)) * M,
                                                          kind=2, fill_value=nan, bounds_error=False),
                              'sigma_10000': interpolate.interp1d(array((600, 650, 700)) + T0,
                                                                  array((170, 110, 65)) * M,
...
materials.append(Material('10Х11Н20Т3Р',
                          {
                              'sigma_s': interpolate.interp1d(array((20, 400, 600, 700, 750, 800)) + T0,
                                                              array((1000, 950, 800, 680, 560, 360)) * M,
                                                              kind=3, fill_value=nan, bounds_error=False),
                              'sigma_t': interpolate.interp1d(array((20, 400, 600, 700, 750, 800)) + T0,
                                                              array((600, 600, 530, 470, 450, 250)) * M,
                                                              kind=3, fill_value=nan, bounds_error=False),
                              'sigma_100': interpolate.interp1d(array((500, 550, 600, 650, 700, 750)) + T0,
                                                                array((730, 650, 590, 480, 400, 280)) * M,
                                                                kind=3, fill_value=nan, bounds_error=False), },
                          reference=REFERENCES[2] + ', c. 409-410', ))
materials.append(Material('09Х14Н19В2БР',
                          {
                              'sigma_s': interpolate.interp1d(array((20, 600, 650, 700)) + T0,
                              ...
                              'sigma_t': interpolate.interp1d(array((20, 600, 650, 700)) + T0,
                                                              ...
                                                              kind=3, fill_value=nan, bounds_error=False),
                              'KCU': interpolate.interp1d(array((20, 600, 650, 700)) + T0,
                                                          array((1.8, 2.2, 2.1, 2.2)) * M,
                                                          kind=3, fill_value=nan, bounds_error=False),
                              'sigma_10000': interpolate.interp1d(array((600, 650, 700, 750)) + T0,
                                                                  array((270, 168, 125, 70)) * M,
                                                                  kind=3, fill_value=nan, bounds_error=False),
                              'sigma_100000': interpolate.interp1d(array((600, 650, 700, 750)) + T0,
                                                                   array((200, 130, 95, 55)) * M,
                                                                   kind=3, fill_value=nan, bounds_error=False),
                              'E': interpolate.interp1d(array((20, 100, 200, 300, 400, 500, 600, 700)) + T0,
                                                        array((202, 199, 193, 186, 178, 168, 160, 152)) * 10 ** 9,
                                                        kind=3, fill_value=nan, bounds_error=False),
                              'l': interpolate.interp1d(array((20, 100, 200, 300, 400, 500, 600, 700, 800)) + T0,
                                                        array((15.4, 16.3, 16.3, 18.0, 19.2, 21.3, 23.4, 25.1, 27.6)),
                                                        kind=3, fill_value=nan, bounds_error=False),
                              'alpha': interpolate.interp1d(array((100, 200, 300, 400, 500, 600, 700, 800)) + T0,
                                                            array((15.2, 16.3, 16.9, 17.5, 17.8, 18.1, 18.6, 18.6)) / M,
                                                            kind=3, fill_value=nan, bounds_error=False), },
                          reference=REFERENCES[2] + ', c. 410', ))
materials.append(Material('08Х15Н24В4ТР',
                          {
                              'sigma_s': interpolate.interp1d(array((20, 650, 700, 750)) + T0,
                                                              array((750, 650, 600, 500)) * M,
                                                              kind=3, fill_value=nan, bounds_error=False),
                              'sigma_t': interpolate.interp1d(array((20, 650, 700, 750)) + T0,
                                                              array((500, 450, 400, 350)) * M,
                                                              kind=3, fill_value=nan, bounds_error=False),
                              'KCU': interpolate.interp1d(array((20, 650, 700, 750)) + T0,
                                                          array((1.2, 1.01, 1.0, 0.1)) * M,
                                                          kind=3, fill_value=nan, bounds_error=False),
                              'sigma_1000': interpolate.interp1d(array((600, 650, 700, 750)) + T0,
